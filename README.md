...
We have a flask app which builds on **Nginx** and **Gunicorn** 
...
Environmental setup is mentioned above for docker pre-requisites. 

## Check the web service

$ curl 127.0.0.1
Hello Container World! I have been seen 1 times and my hostname is xxxxxxxx
